    ...
    <>
       <div className = {cn("modal", `${className}`)}>
            <div className={cn("modalOpen")}>
                ...
                {primaryBtn && (
                    <button className={cn("modal-button", primaryBtn.className)} onClick={primaryBtn.onClick}>{primaryBtn.text}</button>
                    )}
                {secondaryBtn && (
                    <button className={cn("modal-button",secondaryBtn.className)} onClick={secondaryBtn.onClick}>{secondaryBtn.text}</button>
                    )}
            </div>
    </div>
